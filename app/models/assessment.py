...
class EmploymentRelated(Base):
    ...
    no_employment_experience: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    attended_job_selection_office: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    received_employment_assessment: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    employment_other_experience: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
